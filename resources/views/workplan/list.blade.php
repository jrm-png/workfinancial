    ...
    <script>
        ...
        const columnDefs = [
            ...
            { 
                ...
                cellRenderer: params => {
                    ...
                    const ogmGroupRCs = ['OGM', 'OAGM', 'SMO', 'PIU', 'IAD', 'LAD', 'PPIMD','BOD'];
        ...
        window.addEventListener("load", () => {
            ...
            // Restore search
            const savedSearch = sessionStorage.getItem("workplanSearch");

            if (savedSearch) {
                document.getElementById("filter-text-box").value = savedSearch;
                gridApi.setGridOption("quickFilterText", savedSearch);
            }

            // Restore page
            const savedPage = sessionStorage.getItem("workplanPage");

            if (savedPage !== null) {
                gridApi.paginationGoToPage(Number(savedPage));
            }
